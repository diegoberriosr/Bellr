...
const PostButton = ({ handleClick, mobile }) => {
    ...
    return (
        <button className={`relative flex items-center justify-center min-w-[55px] min-h-[55px] w-11/12 p-2.5 rounded-full sm:rounded-3xl ${mode.color} hover:bg-opacity-85 text-white text-lg font-bold`} onClick={handleClick}>
