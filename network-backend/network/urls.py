...
urlpatterns = [
    ...
    path('search', views.get_user, name='users'),
    ...
    path('reply/<int:post_id>', views.create_reply, name='reply'),
    path('notifications', views.get_notifications, name='notifications'),
    path('notifications/watch', views.see_notification, name='watch notification'),
    path('notifications/unseen', views.unseen_notifications, name='unseen notifications'),
