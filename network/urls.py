...
urlpatterns = [
    ...
    path("posts", views.get_posts_all, name="posts"),
    path("posts/<int:post_id>", views.get_post_by_id, name="post"),
    path("posts/username/<str:username>", views.get_posts_by_username, name='posts-username'),
    path("posts/profile", views.get_profile_posts, name='profile'),
    path("posts/user/<int:user_id>", views.get_posts_by_user, name="user"),
    path("posts/feed", views.get_feed, name='feed'),
    path("posts/bookmarked", views.get_bookmarked, name="bookmarked"),
